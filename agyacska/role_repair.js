...
MyRoom.prototype.repair = function () {
    ...
    if (this.storage) {
        if (this.resources[RESOURCE_ENERGY] > 10000 && this.constructionSites.length) { chooseBuildObject(this, task) }
        ...
        if (this.terminal.store[RESOURCE_ENERGY] > 1000 && this.constructionSites.length) { chooseBuildObject(this, task) }
