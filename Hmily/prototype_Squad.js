...
Squad.prototype.attack = function () {
    ...
    creeps.forEach(creep => {
        ...
        let structures = []
        if (creep.room.controller && creep.room.controller.owner && creep.room.controller.owner.username !== settings.username) { structures = creep.pos.findInRange(FIND_STRUCTURES, 3, { filter: str => !this.structuresFilter.includes(str.structureType) && str.structureType !== 'controller' && str.structureType !== 'powerBank' && str.structureType !== 'portal' }) }
