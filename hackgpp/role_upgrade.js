'use strict'
// 190000 => 100000 tick to spawn upgrade
//2023.09.20 fill controller link if storage store energy > 10000
...
MyRoom.prototype.upgrade = function () {
    ...
    if (link && link.store.getUsedCapacity(RESOURCE_ENERGY) < 600 && this.storage && this.storage.store['energy'] > 10000) {
...
MyRoom.prototype.manageTaskUpgrade = function () {
    ...
    if (this.level < 8 || (this.level == 8 && this.room.controller.ticksToDowngrade < 100000) || settings.tasks.alwaysUpgrade) {
        const role = 'upgrade'
